...
nameAndAge.push("Joe Joseph"); // Should not be allowed
...
// However, making the tuple readonly makes the elements read-only. So, we cannot change the value of any of the elements even if we use the correct type:
